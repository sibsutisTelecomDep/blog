...
Android SDK включает множество виджетов
...
Рис. 2. Иерархия класса View. [Источник](https://www.mathematik.uni-marburg.de/~thormae/lectures/graphics1/media/vectorart/android_class_hierarchy_view.svg).